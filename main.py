...
# Helper scripts
from Helper_scripts.get_reference import get_reference_poses, create_ref_orientation
from Nodes.generate_vizMarkerMsg import generate_LineSegment, generate_PointMarkerMsg, generate_arrow_msg
...
def main():
    ...
    tcomp_max = 0
    tcomp_sum = 0
    constraint, model, acados_solver = acados_settings(track_width=2*d, Tf=Tf, N=N)
    ...
    while not rospy.is_shutdown():
        ...
        predVisMsg = generate_LineSegment(opt_xi[:, :2], id=5, colors=[1.0, 0.0, 0.0])
